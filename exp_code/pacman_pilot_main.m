...
% 'lk_mac' -- DB mac, 'lk_git_mac -- git mac'

[basedir, session_no, sid, subject_dir] = pacman_directory_sub_info('lk_git_mac');
...
pacman_pilot_run_core(basedir, subject_dir, sid, session_no, low_level_order, 'testmode')
